//this script works on android touch and Win mouse click.
//you need to make new Gui texture and add box collider on it,
//then scale that box collider to mach size of Gui texture.
...
if (call == true){  //when clicked or touched call wil be true and will execute all tasks, to make sure it wont execute it at begining of runtime
 on.active = true; // the things that when clicked or touched on buuton will be executed.
